...
public class Estudiantes2 {
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println("5. Mostrar estudiantes mayores");
                ...
                switch (opcion) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        mostrarMayores(conexion, scanner);
                        break;
                    case 6:
    ...
    private static void mostrarMayores(Connection conexion, Scanner scanner) throws SQLException {
        // Solicita al usuario ingresar la edad mínima
        System.out.print("Ingrese la edad mínima: ");
        int edadMinima = scanner.nextInt();
        scanner.nextLine(); // Consumir la nueva línea después de leer un entero.

        // Consulta SQL para seleccionar estudiantes mayores que la edad mínima ingresada
        String consulta = "SELECT * FROM estudiantes WHERE YEAR(CURDATE()) - YEAR(fecha_nacimiento) > ?";

        // Crea un PreparedStatement para ejecutar la consulta SQL con la edad mínima como valor
        PreparedStatement preparedStatement = conexion.prepareStatement(consulta);
        ...
        // Cierra el ResultSet y el PreparedStatement para liberar recursos
        resultado.close();
        preparedStatement.close();
    }
